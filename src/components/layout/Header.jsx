    ...
    <header className="fixed top-0 left-0 w-full bg-black/20 backdrop-blur-lg shadow-sm z-50">
      <Container className="flex items-center justify-between h-[80px]">
        ...
        <nav className="hidden lg:flex space-x-8 items-center">
          ...
          <Link
            href="/contact"
            className="px-5 py-2 flex items-center gap-1 text-sm bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full font-semibold duration-300 shadow-md hover:scale-105"
          >
