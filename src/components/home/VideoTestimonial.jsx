...
const MediaTestimonials = () => {
  ...
  const testimonials = [
    ...
    { id: 6, type: "image", mediaUrl: "/images/testimonials/11.jpg", description: "Client Review" },
    { id: 7, type: "image", mediaUrl: "/images/testimonials/3.png", description: "Client Review 1" },
    { id: 8, type: "image", mediaUrl: "/images/testimonials/9.jpg", description: "Client Review 1" },
